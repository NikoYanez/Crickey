class ShoesController < ApplicationController
  ...
  def slug
    @shoe = Shoe.slug(params[:slug])
    render 'show'
  end

  def special_deal
    if is_email_submitted?
      @shoe = Shoe.special.sample
      render 'show'
    else
  ...
  private
    ...
    def shoe_params
      params.require(:shoe).permit(:name, :price, :quantity, :sale_start, :sale_end, :slug, :special, :keyword)
    end
end
